...
public class UpdateCompanyUseCase {
    ...
    public UpdateCompanyUseCase(CompanyRepository companyRepository, UnitOfWork unitOfWork) {
        this.companyRepository = companyRepository;
        this.unitOfWork = unitOfWork;
    }

    public CompanyResponse execute(String id, UpdateCompanyCommand command) {
        log.info("Actualizando compania con id: {}", id);
        return unitOfWork.execute(() -> {
            ...
            company.update(command.nombre(), command.direccion(), command.telefono());
