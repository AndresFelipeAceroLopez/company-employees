...
public class UpdateEmployeeUseCase {
    ...
    private static final Logger log = LoggerFactory.getLogger(UpdateEmployeeUseCase.class);
    private final EmployeeRepository employeeRepository;
    private final UnitOfWork unitOfWork;

    public UpdateEmployeeUseCase(EmployeeRepository employeeRepository, UnitOfWork unitOfWork) {
        this.employeeRepository = employeeRepository;
        this.unitOfWork = unitOfWork;
    }

    public EmployeeResponse execute(String id, UpdateEmployeeCommand command) {
        ...
        return unitOfWork.execute(() -> {
            ...
            employee.update(command.nombre(), command.apellido(), command.correo(),
                    command.cargo(), command.salario(), command.status());
